...
(\verb+\sailfn+) for \verb+my_function+.  These can also be used with
escaped version of the names, such as \verb+my\_type+, which is useful
when defining more complex macros.
