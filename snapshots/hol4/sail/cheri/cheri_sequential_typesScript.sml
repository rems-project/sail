(*Generated by Lem from cheri_sequential_types.lem.*)
open HolKernel Parse boolLib bossLib;
open lem_pervasives_extraTheory sail_instr_kindsTheory sail_valuesTheory sail_operators_mwordsTheory state_monadTheory stateTheory;

val _ = numLib.prefer_num();



val _ = new_theory "cheri_sequential_types"
...
val _ = Hol_datatype `
 CauseReg  =   Mk_CauseReg of ( 32 words$word)`;




val _ = Hol_datatype `
 CapCauseReg  =   Mk_CapCauseReg of ( 16 words$word)`;




val _ = Hol_datatype `
 TLBEntryLoReg  =   Mk_TLBEntryLoReg of ( 64 words$word)`;




val _ = Hol_datatype `
 TLBEntryHiReg  =   Mk_TLBEntryHiReg of ( 64 words$word)`;




val _ = Hol_datatype `
 ContextReg  =   Mk_ContextReg of ( 64 words$word)`;




val _ = Hol_datatype `
 XContextReg  =   Mk_XContextReg of ( 64 words$word)`;
...
val _ = Hol_datatype `
 TLBEntry  =   Mk_TLBEntry of ( 117 words$word)`;




val _ = Hol_datatype `
 StatusReg  =   Mk_StatusReg of ( 32 words$word)`;
...
val _ = type_abbrev( "CapReg"  , ``: 257 bits``);
...
val _ = type_abbrev( "CapLen"  , ``: int``);

val _ = type_abbrev( "uint64"  , ``: int``);

val _ = Hol_datatype `
 CPtrCmpOp = CEQ | CNE | CLT | CLE | CLTU | CLEU | CEXEQ | CNEXEQ`;




val _ = Hol_datatype `
 ClearRegSet = GPLo | GPHi | CLo | CHi`;
...
val _ = Hol_datatype `
 ast  =
  ...
  | SYSCALL_THREAD_START of (unit)
  | ImplementationDefinedStopFetching of (unit)
  | SYSCALL of (unit)
  | BREAK of (unit)
  | WAIT of (unit)
  ...
  | ERET of (unit)
  | CGetPerm of ((regno # regno))
  | CGetType of ((regno # regno))
  | CGetBase of ((regno # regno))
  | CGetLen of ((regno # regno))
  | CGetTag of ((regno # regno))
  | CGetSealed of ((regno # regno))
  | CGetOffset of ((regno # regno))
  | CGetAddr of ((regno # regno))
  | CGetPCC of (regno)
  | CGetPCCSetOffset of ((regno # regno))
  | CGetCause of (regno)
  | CSetCause of (regno)
  | CReadHwr of ((regno # regno))
  | CWriteHwr of ((regno # regno))
  | CAndPerm of ((regno # regno # regno))
  | CToPtr of ((regno # regno # regno))
  | CSub of ((regno # regno # regno))
  | CPtrCmp of ((regno # regno # regno # CPtrCmpOp))
  | CIncOffset of ((regno # regno # regno))
  | CIncOffsetImmediate of ((regno # regno # 11 bits))
  | CSetOffset of ((regno # regno # regno))
  | CSetBounds of ((regno # regno # regno))
  | CSetBoundsImmediate of ((regno # regno # 11 bits))
  | CSetBoundsExact of ((regno # regno # regno))
  | CClearTag of ((regno # regno))
  | CMOVX of ((regno # regno # regno # bool))
  | ClearRegs of ((ClearRegSet # 16 bits))
  | CFromPtr of ((regno # regno # regno))
  | CBuildCap of ((regno # regno # regno))
  | CCopyType of ((regno # regno # regno))
  | CCheckPerm of ((regno # regno))
  | CCheckType of ((regno # regno))
  | CTestSubset of ((regno # regno # regno))
  | CSeal of ((regno # regno # regno))
  | CCSeal of ((regno # regno # regno))
  | CUnseal of ((regno # regno # regno))
  | CCall of ((regno # regno # 11 bits))
  | CReturn of (unit)
  | CBX of ((regno # 16 bits # bool))
  | CBZ of ((regno # 16 bits # bool))
  | CJALR of ((regno # regno # bool))
  | CLoad of ((regno # regno # regno # 8 bits # bool # WordType # bool))
  | CStore of ((regno # regno # regno # regno # 8 bits # WordType # bool))
  | CSC of ((regno # regno # regno # regno # 11 bits # bool))
  | CLC of ((regno # regno # regno # 11 bits # bool))
  | C2Dump of (regno)
  | RI of (unit)`;
...
val _ = Hol_datatype `
 register_value  =
    Regval_vector of ((sail_values$ii # bool # register_value list))
  | Regval_list of ( register_value list)
  | Regval_option of ( register_value option)
  | Regval_CapCauseReg of (CapCauseReg)
  ...
  | Regval_vector_257_dec_bit of ( 257 words$word)
...
val _ = Hol_datatype `
 regstate  =
  <| CapCause : CapCauseReg;
     CTLSP :  257 words$word;
     CTLSU :  257 words$word;
     C31 :  257 words$word;
     C30 :  257 words$word;
     C29 :  257 words$word;
     C28 :  257 words$word;
     ...
     C01 :  257 words$word;
     C00 :  257 words$word;
     inCCallDelay :  1 words$word;
     delayedPCC :  257 words$word;
     nextPCC :  257 words$word;
     PCC :  257 words$word;
...
(*val CapCauseReg_of_regval : register_value -> Maybe.maybe CapCauseReg*)

val _ = Define `
 ((CapCauseReg_of_regval:register_value ->(CapCauseReg)option) merge_var=   
 ((case merge_var of   Regval_CapCauseReg (v) => SOME v | g__113 => NONE )))`;


(*val regval_of_CapCauseReg : CapCauseReg -> register_value*)

val _ = Define `
 ((regval_of_CapCauseReg:CapCauseReg -> register_value) v=  (Regval_CapCauseReg v))`;


(*val CauseReg_of_regval : register_value -> Maybe.maybe CauseReg*)

val _ = Define `
 ((CauseReg_of_regval:register_value ->(CauseReg)option) merge_var=   
 ((case merge_var of   Regval_CauseReg (v) => SOME v | g__112 => NONE )))`;
...
(*val ContextReg_of_regval : register_value -> Maybe.maybe ContextReg*)

val _ = Define `
 ((ContextReg_of_regval:register_value ->(ContextReg)option) merge_var=   
 ((case merge_var of   Regval_ContextReg (v) => SOME v | g__111 => NONE )))`;
...
(*val StatusReg_of_regval : register_value -> Maybe.maybe StatusReg*)

val _ = Define `
 ((StatusReg_of_regval:register_value ->(StatusReg)option) merge_var=   
 ((case merge_var of   Regval_StatusReg (v) => SOME v | g__110 => NONE )))`;
...
(*val TLBEntry_of_regval : register_value -> Maybe.maybe TLBEntry*)

val _ = Define `
 ((TLBEntry_of_regval:register_value ->(TLBEntry)option) merge_var=   
 ((case merge_var of   Regval_TLBEntry (v) => SOME v | g__109 => NONE )))`;
...
(*val TLBEntryHiReg_of_regval : register_value -> Maybe.maybe TLBEntryHiReg*)

val _ = Define `
 ((TLBEntryHiReg_of_regval:register_value ->(TLBEntryHiReg)option) merge_var=   
 ((case merge_var of   Regval_TLBEntryHiReg (v) => SOME v | g__108 => NONE )))`;
...
(*val TLBEntryLoReg_of_regval : register_value -> Maybe.maybe TLBEntryLoReg*)

val _ = Define `
 ((TLBEntryLoReg_of_regval:register_value ->(TLBEntryLoReg)option) merge_var=   
 ((case merge_var of   Regval_TLBEntryLoReg (v) => SOME v | g__107 => NONE )))`;
...
(*val XContextReg_of_regval : register_value -> Maybe.maybe XContextReg*)

val _ = Define `
 ((XContextReg_of_regval:register_value ->(XContextReg)option) merge_var=   
 ((case merge_var of   Regval_XContextReg (v) => SOME v | g__106 => NONE )))`;
...
(*val vector_16_dec_bit_of_regval : register_value -> Maybe.maybe (Machine_word.mword Machine_word.ty16)*)

val _ = Define `
 ((vector_16_dec_bit_of_regval:register_value ->((16)words$word)option) merge_var=   
 ((case merge_var of   Regval_vector_16_dec_bit (v) => SOME v | g__105 => NONE )))`;


(*val regval_of_vector_16_dec_bit : Machine_word.mword Machine_word.ty16 -> register_value*)

val _ = Define `
 ((regval_of_vector_16_dec_bit:(16)words$word -> register_value) v=  (Regval_vector_16_dec_bit v))`;


(*val vector_1_dec_bit_of_regval : register_value -> Maybe.maybe (Machine_word.mword Machine_word.ty1)*)

val _ = Define `
 ((vector_1_dec_bit_of_regval:register_value ->((1)words$word)option) merge_var=   
 ((case merge_var of   Regval_vector_1_dec_bit (v) => SOME v | g__104 => NONE )))`;


(*val regval_of_vector_1_dec_bit : Machine_word.mword Machine_word.ty1 -> register_value*)

val _ = Define `
 ((regval_of_vector_1_dec_bit:(1)words$word -> register_value) v=  (Regval_vector_1_dec_bit v))`;


(*val vector_257_dec_bit_of_regval : register_value -> Maybe.maybe (Machine_word.mword Machine_word.ty257)*)

val _ = Define `
 ((vector_257_dec_bit_of_regval:register_value ->((257)words$word)option) merge_var=   
 ((case merge_var of   Regval_vector_257_dec_bit (v) => SOME v | g__103 => NONE )))`;


(*val regval_of_vector_257_dec_bit : Machine_word.mword Machine_word.ty257 -> register_value*)

val _ = Define `
 ((regval_of_vector_257_dec_bit:(257)words$word -> register_value) v=  (Regval_vector_257_dec_bit v))`;


(*val vector_32_dec_bit_of_regval : register_value -> Maybe.maybe (Machine_word.mword Machine_word.ty32)*)

val _ = Define `
 ((vector_32_dec_bit_of_regval:register_value ->((32)words$word)option) merge_var=   
 ((case merge_var of   Regval_vector_32_dec_bit (v) => SOME v | g__102 => NONE )))`;


(*val regval_of_vector_32_dec_bit : Machine_word.mword Machine_word.ty32 -> register_value*)

val _ = Define `
 ((regval_of_vector_32_dec_bit:(32)words$word -> register_value) v=  (Regval_vector_32_dec_bit v))`;


(*val vector_64_dec_bit_of_regval : register_value -> Maybe.maybe (Machine_word.mword Machine_word.ty64)*)

val _ = Define `
 ((vector_64_dec_bit_of_regval:register_value ->((64)words$word)option) merge_var=   
 ((case merge_var of   Regval_vector_64_dec_bit (v) => SOME v | g__101 => NONE )))`;


(*val regval_of_vector_64_dec_bit : Machine_word.mword Machine_word.ty64 -> register_value*)

val _ = Define `
 ((regval_of_vector_64_dec_bit:(64)words$word -> register_value) v=  (Regval_vector_64_dec_bit v))`;


(*val vector_6_dec_bit_of_regval : register_value -> Maybe.maybe (Machine_word.mword Machine_word.ty6)*)

val _ = Define `
 ((vector_6_dec_bit_of_regval:register_value ->((6)words$word)option) merge_var=   
 ((case merge_var of   Regval_vector_6_dec_bit (v) => SOME v | g__100 => NONE )))`;


(*val regval_of_vector_6_dec_bit : Machine_word.mword Machine_word.ty6 -> register_value*)

val _ = Define `
 ((regval_of_vector_6_dec_bit:(6)words$word -> register_value) v=  (Regval_vector_6_dec_bit v))`;


(*val vector_8_dec_bit_of_regval : register_value -> Maybe.maybe (Machine_word.mword Machine_word.ty8)*)

val _ = Define `
 ((vector_8_dec_bit_of_regval:register_value ->((8)words$word)option) merge_var=   
 ((case merge_var of   Regval_vector_8_dec_bit (v) => SOME v | g__99 => NONE )))`;


(*val regval_of_vector_8_dec_bit : Machine_word.mword Machine_word.ty8 -> register_value*)
...
(*val vector_of_regval : forall 'a. (register_value -> Maybe.maybe 'a) -> register_value -> Maybe.maybe (list 'a)*)
val _ = Define `
...
(*val regval_of_vector : forall 'a. ('a -> register_value) -> Num.integer -> bool -> list 'a -> register_value*)
val _ = Define `
...
(*val list_of_regval : forall 'a. (register_value -> Maybe.maybe 'a) -> register_value -> Maybe.maybe (list 'a)*)
val _ = Define `
...
(*val option_of_regval : forall 'a. (register_value -> Maybe.maybe 'a) -> register_value -> Maybe.maybe (Maybe.maybe 'a)*)
val _ = Define `
 ((option_of_regval:(register_value -> 'a option) -> register_value ->('a option)option) of_regval= 
  (\x .  (case x of   Regval_option v => OPTION_MAP of_regval v | _ => NONE )))`;


(*val regval_of_option : forall 'a. ('a -> register_value) -> Maybe.maybe 'a -> register_value*)
val _ = Define `
...
val _ = Define `
 ((CapCause_ref:((regstate),(register_value),(CapCauseReg))sail_values$register_ref)=  (<|
  name := "CapCause";
  read_from := (\ s .  s.CapCause);
  write_to := (\ v s .  (( s with<| CapCause := v |>)));
  of_regval := (\ v .  CapCauseReg_of_regval v);
  regval_of := (\ v .  regval_of_CapCauseReg v) |>))`;


val _ = Define `
 ((CTLSP_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "CTLSP";
  read_from := (\ s .  s.CTLSP);
  write_to := (\ v s .  (( s with<| CTLSP := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((CTLSU_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "CTLSU";
  read_from := (\ s .  s.CTLSU);
  write_to := (\ v s .  (( s with<| CTLSU := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C30_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C30";
  read_from := (\ s .  s.C30);
  write_to := (\ v s .  (( s with<| C30 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C28_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C28";
  read_from := (\ s .  s.C28);
  write_to := (\ v s .  (( s with<| C28 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C27_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C27";
  read_from := (\ s .  s.C27);
  write_to := (\ v s .  (( s with<| C27 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C26_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C26";
  read_from := (\ s .  s.C26);
  write_to := (\ v s .  (( s with<| C26 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C25_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C25";
  read_from := (\ s .  s.C25);
  write_to := (\ v s .  (( s with<| C25 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C24_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C24";
  read_from := (\ s .  s.C24);
  write_to := (\ v s .  (( s with<| C24 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C23_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C23";
  read_from := (\ s .  s.C23);
  write_to := (\ v s .  (( s with<| C23 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C22_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C22";
  read_from := (\ s .  s.C22);
  write_to := (\ v s .  (( s with<| C22 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C21_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C21";
  read_from := (\ s .  s.C21);
  write_to := (\ v s .  (( s with<| C21 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C20_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C20";
  read_from := (\ s .  s.C20);
  write_to := (\ v s .  (( s with<| C20 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C19_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C19";
  read_from := (\ s .  s.C19);
  write_to := (\ v s .  (( s with<| C19 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C18_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C18";
  read_from := (\ s .  s.C18);
  write_to := (\ v s .  (( s with<| C18 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C17_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C17";
  read_from := (\ s .  s.C17);
  write_to := (\ v s .  (( s with<| C17 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C16_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C16";
  read_from := (\ s .  s.C16);
  write_to := (\ v s .  (( s with<| C16 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C15_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C15";
  read_from := (\ s .  s.C15);
  write_to := (\ v s .  (( s with<| C15 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C14_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C14";
  read_from := (\ s .  s.C14);
  write_to := (\ v s .  (( s with<| C14 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C13_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C13";
  read_from := (\ s .  s.C13);
  write_to := (\ v s .  (( s with<| C13 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C12_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C12";
  read_from := (\ s .  s.C12);
  write_to := (\ v s .  (( s with<| C12 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C11_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C11";
  read_from := (\ s .  s.C11);
  write_to := (\ v s .  (( s with<| C11 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C10_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C10";
  read_from := (\ s .  s.C10);
  write_to := (\ v s .  (( s with<| C10 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C09_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C09";
  read_from := (\ s .  s.C09);
  write_to := (\ v s .  (( s with<| C09 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C08_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C08";
  read_from := (\ s .  s.C08);
  write_to := (\ v s .  (( s with<| C08 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C07_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C07";
  read_from := (\ s .  s.C07);
  write_to := (\ v s .  (( s with<| C07 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C06_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C06";
  read_from := (\ s .  s.C06);
  write_to := (\ v s .  (( s with<| C06 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C05_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C05";
  read_from := (\ s .  s.C05);
  write_to := (\ v s .  (( s with<| C05 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C04_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C04";
  read_from := (\ s .  s.C04);
  write_to := (\ v s .  (( s with<| C04 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C03_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C03";
  read_from := (\ s .  s.C03);
  write_to := (\ v s .  (( s with<| C03 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C02_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C02";
  read_from := (\ s .  s.C02);
  write_to := (\ v s .  (( s with<| C02 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C01_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C01";
  read_from := (\ s .  s.C01);
  write_to := (\ v s .  (( s with<| C01 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C00_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C00";
  read_from := (\ s .  s.C00);
  write_to := (\ v s .  (( s with<| C00 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((inCCallDelay_ref:((regstate),(register_value),((1)words$word))sail_values$register_ref)=  (<|
  name := "inCCallDelay";
  read_from := (\ s .  s.inCCallDelay);
  write_to := (\ v s .  (( s with<| inCCallDelay := v |>)));
  of_regval := (\ v .  vector_1_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_1_dec_bit v) |>))`;


val _ = Define `
 ((nextPCC_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "nextPCC";
  read_from := (\ s .  s.nextPCC);
  write_to := (\ v s .  (( s with<| nextPCC := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((delayedPCC_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "delayedPCC";
  read_from := (\ s .  s.delayedPCC);
  write_to := (\ v s .  (( s with<| delayedPCC := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((PCC_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "PCC";
  read_from := (\ s .  s.PCC);
  write_to := (\ v s .  (( s with<| PCC := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C31_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C31";
  read_from := (\ s .  s.C31);
  write_to := (\ v s .  (( s with<| C31 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((C29_ref:((regstate),(register_value),((257)words$word))sail_values$register_ref)=  (<|
  name := "C29";
  read_from := (\ s .  s.C29);
  write_to := (\ v s .  (( s with<| C29 := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((UART_RVALID_ref:((regstate),(register_value),((1)words$word))sail_values$register_ref)=  (<|
  name := "UART_RVALID";
...
val _ = Define `
 ((UART_RDATA_ref:((regstate),(register_value),((8)words$word))sail_values$register_ref)=  (<|
  name := "UART_RDATA";
...
val _ = Define `
 ((UART_WRITTEN_ref:((regstate),(register_value),((1)words$word))sail_values$register_ref)=  (<|
  name := "UART_WRITTEN";
...
val _ = Define `
 ((UART_WDATA_ref:((regstate),(register_value),((8)words$word))sail_values$register_ref)=  (<|
  name := "UART_WDATA";
...
val _ = Define `
 ((GPR_ref:((regstate),(register_value),(((64)words$word)list))sail_values$register_ref)=  (<|
  name := "GPR";
  read_from := (\ s .  s.GPR);
...
val _ = Define `
 ((LO_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "LO";
  read_from := (\ s .  s.LO);
...
val _ = Define `
 ((HI_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "HI";
  read_from := (\ s .  s.HI);
...
val _ = Define `
 ((delayedPC_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "delayedPC";
...
val _ = Define `
 ((inBranchDelay_ref:((regstate),(register_value),((1)words$word))sail_values$register_ref)=  (<|
  name := "inBranchDelay";
...
val _ = Define `
 ((branchPending_ref:((regstate),(register_value),((1)words$word))sail_values$register_ref)=  (<|
  name := "branchPending";
...
val _ = Define `
 ((CP0Status_ref:((regstate),(register_value),(StatusReg))sail_values$register_ref)=  (<|
  name := "CP0Status";
...
val _ = Define `
 ((CP0UserLocal_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "CP0UserLocal";
...
val _ = Define `
 ((CP0HWREna_ref:((regstate),(register_value),((32)words$word))sail_values$register_ref)=  (<|
  name := "CP0HWREna";
...
val _ = Define `
 ((CP0Count_ref:((regstate),(register_value),((32)words$word))sail_values$register_ref)=  (<|
  name := "CP0Count";
...
val _ = Define `
 ((CP0BadVAddr_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "CP0BadVAddr";
...
val _ = Define `
 ((CP0LLAddr_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "CP0LLAddr";
...
val _ = Define `
 ((CP0LLBit_ref:((regstate),(register_value),((1)words$word))sail_values$register_ref)=  (<|
  name := "CP0LLBit";
...
val _ = Define `
 ((CP0ErrorEPC_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "CP0ErrorEPC";
...
val _ = Define `
 ((CP0EPC_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "CP0EPC";
...
val _ = Define `
 ((CP0Cause_ref:((regstate),(register_value),(CauseReg))sail_values$register_ref)=  (<|
  name := "CP0Cause";
...
val _ = Define `
 ((CP0Compare_ref:((regstate),(register_value),((32)words$word))sail_values$register_ref)=  (<|
  name := "CP0Compare";
...
val _ = Define `
 ((TLBEntry63_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry63";
...
val _ = Define `
 ((TLBEntry62_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry62";
...
val _ = Define `
 ((TLBEntry61_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry61";
...
val _ = Define `
 ((TLBEntry60_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry60";
...
val _ = Define `
 ((TLBEntry59_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry59";
...
val _ = Define `
 ((TLBEntry58_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry58";
...
val _ = Define `
 ((TLBEntry57_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry57";
...
val _ = Define `
 ((TLBEntry56_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry56";
...
val _ = Define `
 ((TLBEntry55_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry55";
...
val _ = Define `
 ((TLBEntry54_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry54";
...
val _ = Define `
 ((TLBEntry53_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry53";
...
val _ = Define `
 ((TLBEntry52_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry52";
...
val _ = Define `
 ((TLBEntry51_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry51";
...
val _ = Define `
 ((TLBEntry50_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry50";
...
val _ = Define `
 ((TLBEntry49_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry49";
...
val _ = Define `
 ((TLBEntry48_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry48";
...
val _ = Define `
 ((TLBEntry47_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry47";
...
val _ = Define `
 ((TLBEntry46_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry46";
...
val _ = Define `
 ((TLBEntry45_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry45";
...
val _ = Define `
 ((TLBEntry44_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry44";
...
val _ = Define `
 ((TLBEntry43_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry43";
...
val _ = Define `
 ((TLBEntry42_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry42";
...
val _ = Define `
 ((TLBEntry41_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry41";
...
val _ = Define `
 ((TLBEntry40_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry40";
...
val _ = Define `
 ((TLBEntry39_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry39";
...
val _ = Define `
 ((TLBEntry38_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry38";
...
val _ = Define `
 ((TLBEntry37_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry37";
...
val _ = Define `
 ((TLBEntry36_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry36";
...
val _ = Define `
 ((TLBEntry35_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry35";
...
val _ = Define `
 ((TLBEntry34_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry34";
...
val _ = Define `
 ((TLBEntry33_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry33";
...
val _ = Define `
 ((TLBEntry32_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry32";
...
val _ = Define `
 ((TLBEntry31_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry31";
...
val _ = Define `
 ((TLBEntry30_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry30";
...
val _ = Define `
 ((TLBEntry29_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry29";
...
val _ = Define `
 ((TLBEntry28_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry28";
...
val _ = Define `
 ((TLBEntry27_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry27";
...
val _ = Define `
 ((TLBEntry26_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry26";
...
val _ = Define `
 ((TLBEntry25_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry25";
...
val _ = Define `
 ((TLBEntry24_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry24";
...
val _ = Define `
 ((TLBEntry23_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry23";
...
val _ = Define `
 ((TLBEntry22_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry22";
...
val _ = Define `
 ((TLBEntry21_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry21";
...
val _ = Define `
 ((TLBEntry20_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry20";
...
val _ = Define `
 ((TLBEntry19_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry19";
...
val _ = Define `
 ((TLBEntry18_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry18";
...
val _ = Define `
 ((TLBEntry17_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry17";
...
val _ = Define `
 ((TLBEntry16_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry16";
...
val _ = Define `
 ((TLBEntry15_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry15";
...
val _ = Define `
 ((TLBEntry14_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry14";
...
val _ = Define `
 ((TLBEntry13_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry13";
...
val _ = Define `
 ((TLBEntry12_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry12";
...
val _ = Define `
 ((TLBEntry11_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry11";
...
val _ = Define `
 ((TLBEntry10_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry10";
...
val _ = Define `
 ((TLBEntry09_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry09";
...
val _ = Define `
 ((TLBEntry08_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry08";
...
val _ = Define `
 ((TLBEntry07_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry07";
...
val _ = Define `
 ((TLBEntry06_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry06";
...
val _ = Define `
 ((TLBEntry05_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry05";
...
val _ = Define `
 ((TLBEntry04_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry04";
...
val _ = Define `
 ((TLBEntry03_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry03";
...
val _ = Define `
 ((TLBEntry02_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry02";
...
val _ = Define `
 ((TLBEntry01_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry01";
...
val _ = Define `
 ((TLBEntry00_ref:((regstate),(register_value),(TLBEntry))sail_values$register_ref)=  (<|
  name := "TLBEntry00";
...
val _ = Define `
 ((TLBXContext_ref:((regstate),(register_value),(XContextReg))sail_values$register_ref)=  (<|
  name := "TLBXContext";
...
val _ = Define `
 ((TLBEntryHi_ref:((regstate),(register_value),(TLBEntryHiReg))sail_values$register_ref)=  (<|
  name := "TLBEntryHi";
...
val _ = Define `
 ((TLBWired_ref:((regstate),(register_value),((6)words$word))sail_values$register_ref)=  (<|
  name := "TLBWired";
...
val _ = Define `
 ((TLBPageMask_ref:((regstate),(register_value),((16)words$word))sail_values$register_ref)=  (<|
  name := "TLBPageMask";
...
val _ = Define `
 ((TLBContext_ref:((regstate),(register_value),(ContextReg))sail_values$register_ref)=  (<|
  name := "TLBContext";
...
val _ = Define `
 ((TLBEntryLo1_ref:((regstate),(register_value),(TLBEntryLoReg))sail_values$register_ref)=  (<|
  name := "TLBEntryLo1";
...
val _ = Define `
 ((TLBEntryLo0_ref:((regstate),(register_value),(TLBEntryLoReg))sail_values$register_ref)=  (<|
  name := "TLBEntryLo0";
...
val _ = Define `
 ((TLBRandom_ref:((regstate),(register_value),((6)words$word))sail_values$register_ref)=  (<|
  name := "TLBRandom";
...
val _ = Define `
 ((TLBIndex_ref:((regstate),(register_value),((6)words$word))sail_values$register_ref)=  (<|
  name := "TLBIndex";
...
val _ = Define `
 ((TLBProbe_ref:((regstate),(register_value),((1)words$word))sail_values$register_ref)=  (<|
  name := "TLBProbe";
...
val _ = Define `
 ((nextPC_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "nextPC";
...
val _ = Define `
 ((PC_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "PC";
  read_from := (\ s .  s.PC);
...
(*val get_regval : string -> regstate -> Maybe.maybe register_value*)
val _ = Define `
 ((get_regval:string -> regstate ->(register_value)option) reg_name s=  
 (if reg_name = "CapCause" then SOME (CapCause_ref.regval_of (CapCause_ref.read_from s)) else
  if reg_name = "CTLSP" then SOME (CTLSP_ref.regval_of (CTLSP_ref.read_from s)) else
  if reg_name = "CTLSU" then SOME (CTLSU_ref.regval_of (CTLSU_ref.read_from s)) else
  if reg_name = "C30" then SOME (C30_ref.regval_of (C30_ref.read_from s)) else
  if reg_name = "C28" then SOME (C28_ref.regval_of (C28_ref.read_from s)) else
  if reg_name = "C27" then SOME (C27_ref.regval_of (C27_ref.read_from s)) else
  if reg_name = "C26" then SOME (C26_ref.regval_of (C26_ref.read_from s)) else
  if reg_name = "C25" then SOME (C25_ref.regval_of (C25_ref.read_from s)) else
  if reg_name = "C24" then SOME (C24_ref.regval_of (C24_ref.read_from s)) else
  if reg_name = "C23" then SOME (C23_ref.regval_of (C23_ref.read_from s)) else
  if reg_name = "C22" then SOME (C22_ref.regval_of (C22_ref.read_from s)) else
  if reg_name = "C21" then SOME (C21_ref.regval_of (C21_ref.read_from s)) else
  if reg_name = "C20" then SOME (C20_ref.regval_of (C20_ref.read_from s)) else
  if reg_name = "C19" then SOME (C19_ref.regval_of (C19_ref.read_from s)) else
  if reg_name = "C18" then SOME (C18_ref.regval_of (C18_ref.read_from s)) else
  if reg_name = "C17" then SOME (C17_ref.regval_of (C17_ref.read_from s)) else
  if reg_name = "C16" then SOME (C16_ref.regval_of (C16_ref.read_from s)) else
  if reg_name = "C15" then SOME (C15_ref.regval_of (C15_ref.read_from s)) else
  if reg_name = "C14" then SOME (C14_ref.regval_of (C14_ref.read_from s)) else
  if reg_name = "C13" then SOME (C13_ref.regval_of (C13_ref.read_from s)) else
  if reg_name = "C12" then SOME (C12_ref.regval_of (C12_ref.read_from s)) else
  if reg_name = "C11" then SOME (C11_ref.regval_of (C11_ref.read_from s)) else
  if reg_name = "C10" then SOME (C10_ref.regval_of (C10_ref.read_from s)) else
  if reg_name = "C09" then SOME (C09_ref.regval_of (C09_ref.read_from s)) else
  if reg_name = "C08" then SOME (C08_ref.regval_of (C08_ref.read_from s)) else
  if reg_name = "C07" then SOME (C07_ref.regval_of (C07_ref.read_from s)) else
  if reg_name = "C06" then SOME (C06_ref.regval_of (C06_ref.read_from s)) else
  if reg_name = "C05" then SOME (C05_ref.regval_of (C05_ref.read_from s)) else
  if reg_name = "C04" then SOME (C04_ref.regval_of (C04_ref.read_from s)) else
  if reg_name = "C03" then SOME (C03_ref.regval_of (C03_ref.read_from s)) else
  if reg_name = "C02" then SOME (C02_ref.regval_of (C02_ref.read_from s)) else
  if reg_name = "C01" then SOME (C01_ref.regval_of (C01_ref.read_from s)) else
  if reg_name = "C00" then SOME (C00_ref.regval_of (C00_ref.read_from s)) else
  if reg_name = "inCCallDelay" then SOME (inCCallDelay_ref.regval_of (inCCallDelay_ref.read_from s)) else
  if reg_name = "nextPCC" then SOME (nextPCC_ref.regval_of (nextPCC_ref.read_from s)) else
  if reg_name = "delayedPCC" then SOME (delayedPCC_ref.regval_of (delayedPCC_ref.read_from s)) else
  if reg_name = "PCC" then SOME (PCC_ref.regval_of (PCC_ref.read_from s)) else
  if reg_name = "C31" then SOME (C31_ref.regval_of (C31_ref.read_from s)) else
  if reg_name = "C29" then SOME (C29_ref.regval_of (C29_ref.read_from s)) else
...
(*val set_regval : string -> register_value -> regstate -> Maybe.maybe regstate*)
val _ = Define `
 ((set_regval:string -> register_value -> regstate ->(regstate)option) reg_name v s=  
 (if reg_name = "CapCause" then OPTION_MAP (\ v .  CapCause_ref.write_to v s) (CapCause_ref.of_regval v) else
  if reg_name = "CTLSP" then OPTION_MAP (\ v .  CTLSP_ref.write_to v s) (CTLSP_ref.of_regval v) else
  if reg_name = "CTLSU" then OPTION_MAP (\ v .  CTLSU_ref.write_to v s) (CTLSU_ref.of_regval v) else
  if reg_name = "C30" then OPTION_MAP (\ v .  C30_ref.write_to v s) (C30_ref.of_regval v) else
  if reg_name = "C28" then OPTION_MAP (\ v .  C28_ref.write_to v s) (C28_ref.of_regval v) else
  if reg_name = "C27" then OPTION_MAP (\ v .  C27_ref.write_to v s) (C27_ref.of_regval v) else
  if reg_name = "C26" then OPTION_MAP (\ v .  C26_ref.write_to v s) (C26_ref.of_regval v) else
  if reg_name = "C25" then OPTION_MAP (\ v .  C25_ref.write_to v s) (C25_ref.of_regval v) else
  if reg_name = "C24" then OPTION_MAP (\ v .  C24_ref.write_to v s) (C24_ref.of_regval v) else
  if reg_name = "C23" then OPTION_MAP (\ v .  C23_ref.write_to v s) (C23_ref.of_regval v) else
  if reg_name = "C22" then OPTION_MAP (\ v .  C22_ref.write_to v s) (C22_ref.of_regval v) else
  if reg_name = "C21" then OPTION_MAP (\ v .  C21_ref.write_to v s) (C21_ref.of_regval v) else
  if reg_name = "C20" then OPTION_MAP (\ v .  C20_ref.write_to v s) (C20_ref.of_regval v) else
  if reg_name = "C19" then OPTION_MAP (\ v .  C19_ref.write_to v s) (C19_ref.of_regval v) else
  if reg_name = "C18" then OPTION_MAP (\ v .  C18_ref.write_to v s) (C18_ref.of_regval v) else
  if reg_name = "C17" then OPTION_MAP (\ v .  C17_ref.write_to v s) (C17_ref.of_regval v) else
  if reg_name = "C16" then OPTION_MAP (\ v .  C16_ref.write_to v s) (C16_ref.of_regval v) else
  if reg_name = "C15" then OPTION_MAP (\ v .  C15_ref.write_to v s) (C15_ref.of_regval v) else
  if reg_name = "C14" then OPTION_MAP (\ v .  C14_ref.write_to v s) (C14_ref.of_regval v) else
  if reg_name = "C13" then OPTION_MAP (\ v .  C13_ref.write_to v s) (C13_ref.of_regval v) else
  if reg_name = "C12" then OPTION_MAP (\ v .  C12_ref.write_to v s) (C12_ref.of_regval v) else
  if reg_name = "C11" then OPTION_MAP (\ v .  C11_ref.write_to v s) (C11_ref.of_regval v) else
  if reg_name = "C10" then OPTION_MAP (\ v .  C10_ref.write_to v s) (C10_ref.of_regval v) else
  if reg_name = "C09" then OPTION_MAP (\ v .  C09_ref.write_to v s) (C09_ref.of_regval v) else
  if reg_name = "C08" then OPTION_MAP (\ v .  C08_ref.write_to v s) (C08_ref.of_regval v) else
  if reg_name = "C07" then OPTION_MAP (\ v .  C07_ref.write_to v s) (C07_ref.of_regval v) else
  if reg_name = "C06" then OPTION_MAP (\ v .  C06_ref.write_to v s) (C06_ref.of_regval v) else
  if reg_name = "C05" then OPTION_MAP (\ v .  C05_ref.write_to v s) (C05_ref.of_regval v) else
  if reg_name = "C04" then OPTION_MAP (\ v .  C04_ref.write_to v s) (C04_ref.of_regval v) else
  if reg_name = "C03" then OPTION_MAP (\ v .  C03_ref.write_to v s) (C03_ref.of_regval v) else
  if reg_name = "C02" then OPTION_MAP (\ v .  C02_ref.write_to v s) (C02_ref.of_regval v) else
  if reg_name = "C01" then OPTION_MAP (\ v .  C01_ref.write_to v s) (C01_ref.of_regval v) else
  if reg_name = "C00" then OPTION_MAP (\ v .  C00_ref.write_to v s) (C00_ref.of_regval v) else
  if reg_name = "inCCallDelay" then OPTION_MAP (\ v .  inCCallDelay_ref.write_to v s) (inCCallDelay_ref.of_regval v) else
  if reg_name = "nextPCC" then OPTION_MAP (\ v .  nextPCC_ref.write_to v s) (nextPCC_ref.of_regval v) else
  if reg_name = "delayedPCC" then OPTION_MAP (\ v .  delayedPCC_ref.write_to v s) (delayedPCC_ref.of_regval v) else
  if reg_name = "PCC" then OPTION_MAP (\ v .  PCC_ref.write_to v s) (PCC_ref.of_regval v) else
  if reg_name = "C31" then OPTION_MAP (\ v .  C31_ref.write_to v s) (C31_ref.of_regval v) else
  if reg_name = "C29" then OPTION_MAP (\ v .  C29_ref.write_to v s) (C29_ref.of_regval v) else
...
val _ = type_abbrev((* ( 'a, 'r) *) "MR" , ``: (regstate, 'a, 'r, exception) state_monad$monadRS``);
val _ = type_abbrev((*  'a *) "M" , ``: (regstate, 'a, exception) state_monad$monadS``);
val _ = export_theory()
