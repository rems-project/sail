(*Generated by Lem from cheri_types.lem.*)
...
val _ = Hol_datatype `
 CapCauseReg  = <| CapCauseReg_CapCauseReg_chunk_0 :  16 words$word  |>`;
...
val _ = Hol_datatype `
 ast  =
  ...
  | CLC of ((regno # regno # regno # 16 bits # bool))
  | C2Dump of (regno)
  | RI of (unit)`;
...
val _ = Define `
 ((CapCauseReg_of_regval:register_value ->(CapCauseReg)option) merge_var=
    ((case merge_var of   Regval_CapCauseReg (v) => SOME v | g__16 => NONE )))`;
...
val _ = Define `
 ((CauseReg_of_regval:register_value ->(CauseReg)option) merge_var=
    ((case merge_var of   Regval_CauseReg (v) => SOME v | g__15 => NONE )))`;
...
val _ = Define `
 ((ContextReg_of_regval:register_value ->(ContextReg)option) merge_var=
    ((case merge_var of   Regval_ContextReg (v) => SOME v | g__14 => NONE )))`;
...
val _ = Define `
 ((StatusReg_of_regval:register_value ->(StatusReg)option) merge_var=
    ((case merge_var of   Regval_StatusReg (v) => SOME v | g__13 => NONE )))`;
...
val _ = Define `
 ((TLBEntry_of_regval:register_value ->(TLBEntry)option) merge_var=
    ((case merge_var of   Regval_TLBEntry (v) => SOME v | g__12 => NONE )))`;
...
val _ = Define `
 ((TLBEntryHiReg_of_regval:register_value ->(TLBEntryHiReg)option) merge_var=
    ((case merge_var of   Regval_TLBEntryHiReg (v) => SOME v | g__11 => NONE )))`;
...
val _ = Define `
 ((TLBEntryLoReg_of_regval:register_value ->(TLBEntryLoReg)option) merge_var=
    ((case merge_var of   Regval_TLBEntryLoReg (v) => SOME v | g__10 => NONE )))`;
...
val _ = Define `
 ((XContextReg_of_regval:register_value ->(XContextReg)option) merge_var=
    ((case merge_var of   Regval_XContextReg (v) => SOME v | g__9 => NONE )))`;
...
val _ = Define `
 ((int_of_regval:register_value ->(int)option) merge_var=  ((case merge_var of   Regval_int (v) => SOME v | g__8 => NONE )))`;
...
val _ = Define `
 ((vector_16_dec_bit_of_regval:register_value ->((16)words$word)option) merge_var=
    ((case merge_var of   Regval_vector_16_dec_bit (v) => SOME v | g__7 => NONE )))`;
...
val _ = Define `
 ((vector_1_dec_bit_of_regval:register_value ->((1)words$word)option) merge_var=
    ((case merge_var of   Regval_vector_1_dec_bit (v) => SOME v | g__6 => NONE )))`;
...
val _ = Define `
 ((vector_257_dec_bit_of_regval:register_value ->((257)words$word)option) merge_var=
    ((case merge_var of   Regval_vector_257_dec_bit (v) => SOME v | g__5 => NONE )))`;
...
val _ = Define `
 ((instCount_ref:((regstate),(register_value),(int))register_ref)=  (<|
  name := "instCount";
  read_from := (\ s .  s.instCount);
  write_to := (\ v s .  (( s with<| instCount := v |>)));
  of_regval := (\ v .  int_of_regval v);
  regval_of := (\ v .  regval_of_int v) |>))`;


val _ = Define `
 ((CapCause_ref:((regstate),(register_value),(CapCauseReg))register_ref)=  (<|
  name := "CapCause";
...
val _ = Define `
 ((KDC_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "KDC";
  read_from := (\ s .  s.KDC);
  write_to := (\ v s .  (( s with<| KDC := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((KR2C_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "KR2C";
  read_from := (\ s .  s.KR2C);
  write_to := (\ v s .  (( s with<| KR2C := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((KR1C_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "KR1C";
  read_from := (\ s .  s.KR1C);
  write_to := (\ v s .  (( s with<| KR1C := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((CTLSP_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "CTLSP";
  read_from := (\ s .  s.CTLSP);
...
val _ = Define `
 ((CTLSU_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "CTLSU";
  read_from := (\ s .  s.CTLSU);
...
val _ = Define `
 ((C31_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C31";
  read_from := (\ s .  s.C31);
...
val _ = Define `
 ((C30_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C30";
  read_from := (\ s .  s.C30);
...
val _ = Define `
 ((C29_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C29";
  read_from := (\ s .  s.C29);
...
val _ = Define `
 ((C28_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C28";
  read_from := (\ s .  s.C28);
...
val _ = Define `
 ((C27_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C27";
  read_from := (\ s .  s.C27);
...
val _ = Define `
 ((C26_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C26";
  read_from := (\ s .  s.C26);
...
val _ = Define `
 ((C25_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C25";
  read_from := (\ s .  s.C25);
...
val _ = Define `
 ((C24_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C24";
  read_from := (\ s .  s.C24);
...
val _ = Define `
 ((C23_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C23";
  read_from := (\ s .  s.C23);
...
val _ = Define `
 ((C22_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C22";
  read_from := (\ s .  s.C22);
...
val _ = Define `
 ((C21_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C21";
  read_from := (\ s .  s.C21);
...
val _ = Define `
 ((C20_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C20";
  read_from := (\ s .  s.C20);
...
val _ = Define `
 ((C19_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C19";
  read_from := (\ s .  s.C19);
...
val _ = Define `
 ((C18_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C18";
  read_from := (\ s .  s.C18);
...
val _ = Define `
 ((C17_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C17";
  read_from := (\ s .  s.C17);
...
val _ = Define `
 ((C16_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C16";
  read_from := (\ s .  s.C16);
...
val _ = Define `
 ((C15_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C15";
  read_from := (\ s .  s.C15);
...
val _ = Define `
 ((C14_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C14";
  read_from := (\ s .  s.C14);
...
val _ = Define `
 ((C13_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C13";
  read_from := (\ s .  s.C13);
...
val _ = Define `
 ((C12_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C12";
  read_from := (\ s .  s.C12);
...
val _ = Define `
 ((C11_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C11";
  read_from := (\ s .  s.C11);
...
val _ = Define `
 ((C10_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C10";
  read_from := (\ s .  s.C10);
...
val _ = Define `
 ((C09_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C09";
  read_from := (\ s .  s.C09);
...
val _ = Define `
 ((C08_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C08";
  read_from := (\ s .  s.C08);
...
val _ = Define `
 ((C07_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C07";
  read_from := (\ s .  s.C07);
...
val _ = Define `
 ((C06_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C06";
  read_from := (\ s .  s.C06);
...
val _ = Define `
 ((C05_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C05";
  read_from := (\ s .  s.C05);
...
val _ = Define `
 ((C04_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C04";
  read_from := (\ s .  s.C04);
...
val _ = Define `
 ((C03_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C03";
  read_from := (\ s .  s.C03);
...
val _ = Define `
 ((C02_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C02";
  read_from := (\ s .  s.C02);
...
val _ = Define `
 ((C01_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "C01";
  read_from := (\ s .  s.C01);
...
val _ = Define `
 ((DDC_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "DDC";
  read_from := (\ s .  s.DDC);
  write_to := (\ v s .  (( s with<| DDC := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((inCCallDelay_ref:((regstate),(register_value),((1)words$word))register_ref)=  (<|
  name := "inCCallDelay";
...
val _ = Define `
 ((nextPCC_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "nextPCC";
...
val _ = Define `
 ((delayedPCC_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "delayedPCC";
...
val _ = Define `
 ((PCC_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "PCC";
  read_from := (\ s .  s.PCC);
...
val _ = Define `
 ((KCC_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "KCC";
  read_from := (\ s .  s.KCC);
  write_to := (\ v s .  (( s with<| KCC := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;


val _ = Define `
 ((EPCC_ref:((regstate),(register_value),((257)words$word))register_ref)=  (<|
  name := "EPCC";
  read_from := (\ s .  s.EPCC);
  write_to := (\ v s .  (( s with<| EPCC := v |>)));
  of_regval := (\ v .  vector_257_dec_bit_of_regval v);
  regval_of := (\ v .  regval_of_vector_257_dec_bit v) |>))`;
...
val _ = Define `
 ((get_regval:string -> regstate ->(register_value)option) reg_name s=
   (if reg_name = "instCount" then SOME (instCount_ref.regval_of (instCount_ref.read_from s)) else
  if reg_name = "CapCause" then SOME (CapCause_ref.regval_of (CapCause_ref.read_from s)) else
  if reg_name = "KDC" then SOME (KDC_ref.regval_of (KDC_ref.read_from s)) else
  if reg_name = "KR2C" then SOME (KR2C_ref.regval_of (KR2C_ref.read_from s)) else
  if reg_name = "KR1C" then SOME (KR1C_ref.regval_of (KR1C_ref.read_from s)) else
  ...
  if reg_name = "DDC" then SOME (DDC_ref.regval_of (DDC_ref.read_from s)) else
  ...
  if reg_name = "KCC" then SOME (KCC_ref.regval_of (KCC_ref.read_from s)) else
  if reg_name = "EPCC" then SOME (EPCC_ref.regval_of (EPCC_ref.read_from s)) else
...
val _ = Define `
 ((set_regval:string -> register_value -> regstate ->(regstate)option) reg_name v s=
   (if reg_name = "instCount" then OPTION_MAP (\ v .  instCount_ref.write_to v s) (instCount_ref.of_regval v) else
  if reg_name = "CapCause" then OPTION_MAP (\ v .  CapCause_ref.write_to v s) (CapCause_ref.of_regval v) else
  if reg_name = "KDC" then OPTION_MAP (\ v .  KDC_ref.write_to v s) (KDC_ref.of_regval v) else
  if reg_name = "KR2C" then OPTION_MAP (\ v .  KR2C_ref.write_to v s) (KR2C_ref.of_regval v) else
  if reg_name = "KR1C" then OPTION_MAP (\ v .  KR1C_ref.write_to v s) (KR1C_ref.of_regval v) else
  ...
  if reg_name = "DDC" then OPTION_MAP (\ v .  DDC_ref.write_to v s) (DDC_ref.of_regval v) else
  ...
  if reg_name = "KCC" then OPTION_MAP (\ v .  KCC_ref.write_to v s) (KCC_ref.of_regval v) else
  if reg_name = "EPCC" then OPTION_MAP (\ v .  EPCC_ref.write_to v s) (EPCC_ref.of_regval v) else
