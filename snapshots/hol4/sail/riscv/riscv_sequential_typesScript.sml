(*Generated by Lem from riscv_sequential_types.lem.*)
...
val _ = new_theory "riscv_sequential_types"
...
val _ = Hol_datatype `
 PTW_Result  =
    PTW_Success of ((paddr39 # SV39_PTE # paddr39 # sail_values$ii # bool)) | PTW_Failure of (PTW_Error)`;
...
(*val Mcause_of_regval : register_value -> Maybe.maybe Mcause*)
...
(*val Medeleg_of_regval : register_value -> Maybe.maybe Medeleg*)
...
(*val Minterrupts_of_regval : register_value -> Maybe.maybe Minterrupts*)
...
(*val Misa_of_regval : register_value -> Maybe.maybe Misa*)
...
(*val Mstatus_of_regval : register_value -> Maybe.maybe Mstatus*)
...
(*val Mtvec_of_regval : register_value -> Maybe.maybe Mtvec*)
...
(*val Privilege_of_regval : register_value -> Maybe.maybe Privilege*)
...
(*val Sedeleg_of_regval : register_value -> Maybe.maybe Sedeleg*)
...
(*val Sinterrupts_of_regval : register_value -> Maybe.maybe Sinterrupts*)
...
(*val TLB39_Entry_of_regval : register_value -> Maybe.maybe TLB39_Entry*)
...
val _ = Define `
 ((tlb39_ref:((regstate),(register_value),((TLB39_Entry)option))sail_values$register_ref)=  (<|
  name := "tlb39";
  read_from := (\ s .  s.tlb39);
...
val _ = Define `
 ((stval_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "stval";
  read_from := (\ s .  s.stval);
...
val _ = Define `
 ((scause_ref:((regstate),(register_value),(Mcause))sail_values$register_ref)=  (<|
  name := "scause";
...
val _ = Define `
 ((sepc_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "sepc";
  read_from := (\ s .  s.sepc);
...
val _ = Define `
 ((sscratch_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "sscratch";
...
val _ = Define `
 ((stvec_ref:((regstate),(register_value),(Mtvec))sail_values$register_ref)=  (<|
  name := "stvec";
  read_from := (\ s .  s.stvec);
...
val _ = Define `
 ((satp_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "satp";
  read_from := (\ s .  s.satp);
...
val _ = Define `
 ((sideleg_ref:((regstate),(register_value),(Sinterrupts))sail_values$register_ref)=  (<|
  name := "sideleg";
...
val _ = Define `
 ((sedeleg_ref:((regstate),(register_value),(Sedeleg))sail_values$register_ref)=  (<|
  name := "sedeleg";
...
val _ = Define `
 ((pmpcfg0_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "pmpcfg0";
...
val _ = Define `
 ((pmpaddr0_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "pmpaddr0";
...
val _ = Define `
 ((mhartid_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mhartid";
...
val _ = Define `
 ((marchid_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "marchid";
...
val _ = Define `
 ((mimpid_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mimpid";
...
val _ = Define `
 ((mvendorid_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mvendorid";
...
val _ = Define `
 ((minstret_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "minstret";
...
val _ = Define `
 ((mtime_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mtime";
  read_from := (\ s .  s.mtime);
...
val _ = Define `
 ((mcycle_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mcycle";
...
val _ = Define `
 ((mscratch_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mscratch";
...
val _ = Define `
 ((mtval_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mtval";
  read_from := (\ s .  s.mtval);
...
val _ = Define `
 ((mepc_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "mepc";
  read_from := (\ s .  s.mepc);
...
val _ = Define `
 ((mcause_ref:((regstate),(register_value),(Mcause))sail_values$register_ref)=  (<|
  name := "mcause";
...
val _ = Define `
 ((mtvec_ref:((regstate),(register_value),(Mtvec))sail_values$register_ref)=  (<|
  name := "mtvec";
  read_from := (\ s .  s.mtvec);
...
val _ = Define `
 ((medeleg_ref:((regstate),(register_value),(Medeleg))sail_values$register_ref)=  (<|
  name := "medeleg";
...
val _ = Define `
 ((mideleg_ref:((regstate),(register_value),(Minterrupts))sail_values$register_ref)=  (<|
  name := "mideleg";
...
val _ = Define `
 ((mie_ref:((regstate),(register_value),(Minterrupts))sail_values$register_ref)=  (<|
  name := "mie";
  read_from := (\ s .  s.mie);
...
val _ = Define `
 ((mip_ref:((regstate),(register_value),(Minterrupts))sail_values$register_ref)=  (<|
  name := "mip";
  read_from := (\ s .  s.mip);
...
val _ = Define `
 ((mstatus_ref:((regstate),(register_value),(Mstatus))sail_values$register_ref)=  (<|
  name := "mstatus";
...
val _ = Define `
 ((misa_ref:((regstate),(register_value),(Misa))sail_values$register_ref)=  (<|
  name := "misa";
  read_from := (\ s .  s.misa);
...
val _ = Define `
 ((cur_inst_ref:((regstate),(register_value),((64)words$word))sail_values$register_ref)=  (<|
  name := "cur_inst";
...
val _ = Define `
 ((cur_privilege_ref:((regstate),(register_value),(Privilege))sail_values$register_ref)=  (<|
  name := "cur_privilege";
...
val _ = Define `
 ((Xs_ref:((regstate),(register_value),(((64)words$word)list))sail_values$register_ref)=  (<|
  name := "Xs";
  read_from := (\ s .  s.Xs);
